...
import com.gsu.knowledgebase.service.wikidata.WikidataProperty;
...
//        RepositoryConnection sparqlConnection = sparqlRepository.getConnection();
        ...
        String query = "SELECT DISTINCT ?property ?propertyLabel WHERE { ?property a wikibase:Property . \n" +
    ...
    public static void main(String[] args) throws MediaWikiApiErrorException {
        ...
        EntityDocument q42 = wbdf.getEntityDocument("Q201405");
        System.out
                .println("The current revision of the data for entity Q42 is "
                        + q42.getRevisionId());

        // P279(subclass of) property'sinin degerine erismek icin
        String v = ((JacksonItemDocument) q42).getJsonClaims().get(WikidataProperty.SUBCLASS_OF.getValue()).get(0).getMainsnak().getValue().toString();
        System.out.println("is subclass of " + v);
        //
